...
4. Run the bundled generator from the target repository root:
...
Use `scripts/generate-split-view-diff.py` as the standard-library-only generator. It produces a self-contained HTML file except for optional syntax-highlighting resources loaded by the page.
